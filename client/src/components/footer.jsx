        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <ul className="list-unstyled">
              <li><a className="text-gray" href="#">Home</a></li>
          ...
          <div className="col-md-3">
            ...
            <p className="text-gray">
              Contact<br />
              Somewhere Rd, Toronto, ON, Canada L1G 6Y7<br />
              111-222-3456<br />
              <a href="mailto:contact@medconnet.ca" className="text-gray">contact@medconnet.ca</a>
            </p>
          </div>
        </div>
      </div>
